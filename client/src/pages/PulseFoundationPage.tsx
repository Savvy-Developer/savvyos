...
import { PulseTodosPanel } from "@/components/PulseTodosPanel";
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <Tabs defaultValue="scopes" className="space-y-5">
        ...
        <TabsContent value="todos" className="mt-0"><PulseTodosPanel actorPersonId={data?.actorPersonId ?? 0} /></TabsContent>
