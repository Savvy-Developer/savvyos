...
const NOTIFICATIONS: NotifMeta[] = [
  ...
  { id: "pulse_measurables_submission_confirmation", name: "Pulse Measurables Submission Confirmation", description: "Sent only to the owner after all active measurables are submitted for a reporting week.", trigger: "My Measurables submission is confirmed", triggerType: "Event", recipient: "Assigned User", category: "Pulse" },
