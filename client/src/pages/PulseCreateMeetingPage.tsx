...
const SECTIONS = [
  ...
  { key: "goals", label: "Goals", description: "Connect current work to company goals." },
  ...
  { key: "issues", label: "Issues", description: "Discuss and resolve the most important obstacles." },
  { key: "cascading", label: "Cascading messages", description: "Capture messages that need to travel beyond the meeting." },
  { key: "conclude", label: "Conclude", description: "Confirm commitments and close the meeting." },
] as const;
