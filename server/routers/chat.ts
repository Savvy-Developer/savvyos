  ...
  conversations: router({
    ...
    create: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        // Membership and workspace visibility are distinct. A future agent may
        // be enrolled now, while the explicit rollout gate still keeps Chat
        // completely invisible until that agent is authorized.
