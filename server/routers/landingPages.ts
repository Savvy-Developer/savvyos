...
export const LANDING_PAGE_PUBLIC_TRPC_PATHS = new Set([
  ...
  "marketMatchQuiz.publicConfiguration",
  "marketMatchQuiz.startFromEmail",
  ...
  "marketMatchQuiz.requestAgent",
  "marketMatchQuiz.requestLender",
  "marketMatchQuiz.subscribeDailyProperties",
  "marketMatchQuiz.recordAbandonment",
]);
